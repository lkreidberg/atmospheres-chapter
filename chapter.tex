...
A major step in atmosphere characterization is simply detecting absorbing species. This was first achieved for the hot Jupiter HD 209458b with the detection of the sodium resonance doublet at 589 nm \citep{charbonneau02}. Since then, both sodium and potassium have been detected in a number of other planets \citep[e.g.][]{sing11b, jensen11, nikolov14, fischer16}.

Spectral features from water are also routinely seen \citep[e.g.][]{deming13, huitson13, mccullough14, fraine14, kreidberg14b, kreidberg15b, line16, evans16, iyer16}. Most of these detections come from \HST/WFC3 transmission spectra in the near-IR (1.1 - 1.7 $\mu$m), where water is the dominant absorber. 

There is also evidence for CO and CO$_2$ from \Spitzer\ photometry. However, the \Spitzer\ bandpasses are about $1\,\mu$m wide, and cover spectral features from multiple different absorbing species (CO, CO$_2$, H$_2$O). It is possible to   have been detected from the ground
...
Once an atom or molecule has been detected, a next step is to measure its abundance. The overall metallicity of a planet's atmosphere is 

However, is challenging with transmission spectra alone, because they suffer from a degeneracy between the absorber abundance and atmospheric pressure -- abundances can only be determined to within a few orders of magnitude, even when the absorber is detected at high confidence \citep{benneke12, griffith13, kreidberg15b}. 

Emission spectra are more sensitive to absolute abundance because the shape and amplitude of spectral features depends on the temperature-pressure profile. \citep{kreidberg14b, line16, stevenson17}. 

Cannot do with high-resolution observations.

\runinhead{Abundance Ratios}
In addition to absolute abundances, abundance \emph{ratios} are also a  
...
For hot Jupiters, there is no strong correlation between the presence of clouds and any other physical parameters (temperature, surface gravity) \citep{sing16}. 
C/O - all < 1
...
I am grateful for comments and discussion with Caroline Morley, Jayne Birkby, Jacob Bean.
\end{acknowledgement}
