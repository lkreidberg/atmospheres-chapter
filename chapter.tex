...
With thermal emission measurements, it is possible to characterize a planet's climate in detail. The most common measurement is the dayside brightness temperature, inferred from the planet-to-star flux ratio at secondary eclipse. These measurements have been made for more than 50 planets with \Spitzer/IRAC, revealing temperatures from roughly 1000 to 3000 K \citep{stevenson14b, schwartz15, kammer15, morley17}. 

The temperature on the dayside is related to the planet's heat redistribution efficiency; however, this is degenerate with the \hbindex{Bond albedo} (the fraction of incident flux at the planet that is absorbed).

One  hemisphere average is the brightness temperature planet-to-star flux ratio 

Dayside thermal emission spectroscopy even more detail. Temperature pressure profile
