...
\item{A Spitzer phase curve for the super-Earth 55 Cancri e \citep{demory16}. This measurement revealed a dayside temperature of 2700 K, with a 1300 K drop in temperature to the nightside. There is a large hot spot offset (40 degrees east of the substellar point). It is uncertain whether such a small planet ($2\,R_\oplus$) can maintain an atmosphere, FIXME - either molten rock on the dayside, or an optically thick atmosphere that redistributes ehat FIXME}
\end{itemize}
