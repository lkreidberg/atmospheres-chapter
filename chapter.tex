...
The focus of this chapter is atmosphere characterization through analysis of the combined light from the planet and the star. This creative approach makes use of the star as a as a constant baseline flux source. As the planet moves through its orbit, it absorbs, re-emits, and reflects stellar light. These planetary signal shows up differentially relative to the baseline stellar flux over time, allowing the planet signal to be teased out from the much brighter star.


In this chapter, we overview observing techniques, observing facilities, major results. 
