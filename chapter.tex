...
The eclipse model $E(t)$ is a more straightforward calculation: it is simply the overlapping area of two circles (the sky-projected disk of the star and planet), scaled by the planet-to-star flux ratio $F_p/F_s$ \citep{mandel02}.  This model assumes the brightness of the planet is constant, and neglects planetary limb darkening or other variation in temperature/reflectivity. In practice these variations are only detectable for the highest precision light curves \citep{FIXME}. 
