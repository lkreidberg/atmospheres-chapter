...
Simply detecting features from atoms or molecules in an exoplanet atmosphere is a major feat. It was first accomplished by \cite{charbonneau02}, for sodium in the atmosphere of the hot Jupiter HD 209458b. 
...
%Most aerosols have uniform (so-called "gray") opacity over a relatively wide wavelength range ($\sim1\,\mu$m), and mask transmission of stellar flux below a constant altitude. This serves to truncate spectral features at the level of the clouds or haze (as illustrated in Figure FIXME). 
They can also introduce a slope in the spectrum over wavelength intervals of several microns \citep[e.g][]{sing16}.  The third effect is scattering off cloud and haze particles at optical wavelengths, which introduces a steep increase in transit depth towards the blue \citep[e.g][]{pont08}.

The first hint of extrasolar aerosols came from HD 209458b, which had a smaller than expected sodium feature relative to a clear atmosphere \citep{charbonneau02}. This observation foreshadowed a slew of spectra with truncated features \citep[e.g.][]{deming13, crossfield13, kreidberg14a, knutson14a, kreidberg15b}. Many spectra have also shown the large optical slope indicative of scattering from haze \citep[e.g][]{sing11, sing13, robinson14, dragomir15}.

Despite this body of evidence, the makeup of the aerosols proven elusive. For hot Jupiters, there is no strong correlation between the presence of clouds and any other physical parameters (temperature, surface gravity) \citep{sing16}. When all  


Depending on temperature and pressure, a wide range of equilibrium condensates may form, including salts and sulfides, iron and silicate clouds \citep{marley00, morley13, wakeford15, wakeford17}.

\runinhead{What is the composition of clouds and hazes?}
All of the evidence presented so far has been agnostic on the question of composition.
Strong constraints on aerosol properties come from the super-Earth GJ 1214b. This planet has the highest s

Reflective clouds have also been inferred from optical phase curves of hot Jupiters. Some planets show westward shifted peak brightnesses, which can be explained by reflective clouds on the western hemisphere \citep{demory13, hu15, parmentier16}.
