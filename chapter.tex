...
FIXME: say what a transit light curve is and show a figure. Define "spectroscopic channel" and "white light curve".
...
Near-infrared detectors exhibit a phenomenon known as \bibindex{persistence}, which refers to af. Related to persistence
