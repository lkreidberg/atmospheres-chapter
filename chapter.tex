...
Despite this body of evidence, the makeup of the aerosols has proven elusive. There are a number of theoretical possibilities, including equilibrium condensates such as water, salt, sulfide, or silicate clouds (depending on temperature) and photochemical hazes, e.g. hydrocarbon soots formed from photolyzed methane \citep{marley00, kempton12, morley13, wakeford15, wakeford17}. Current observations lack the wavelength coverage and precision needed to distinguish between these species.  

However, there are several indirect constraints on aerosol composition.  For example, optical phase curves of hot Jupiters are best explained by reflective clouds on their western hemispheres, composed of silicate or manganese sulfide \citep{demory13, oreshenko16, parmentier16}. Additional constraints come from the amplitude of features that would be distinguishable given the precision of a spectrum. For example, the super-Earth GJ 1214b must have optically thick clouds/haze at a pressure of 0.1 millibar, which requires either \citep{kreidberg14a, morley15}.
